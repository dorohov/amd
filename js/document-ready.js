...
var h_window=$(window).height(),w_window=$(window).width(),h_navbar=$(".navbar-site").outerHeight(!0),h_navbar_fixed=$(".navbar-fixed-top").outerHeight(!0),h_header=$(".header-site").outerHeight(!0),h_footer=$(".footer-site").outerHeight(!0),h_resize=h_window-h_navbar-h_footer,h_resize_map=h_window-h_header-50,h_resize_xs=h_window;(device.mobile()||device.tablet())&&$(".navbar").addClass("navbar-fixed-top"),device.mobile()?($(".content-site.second").removeAttr("style"),$("._sspc__bg-text").appendTo("._sspc__cols._director ._inner")):$(".content-site.second").css("min-height",h_resize),$("nav.navbar-fixed-top").autoHidingNavbar();
	}).trigger('resize');
